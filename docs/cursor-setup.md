...
Cursor automatically detects `.cursor/mcp.json` and connects to the Arc MCP server.
...
Go to Settings > Developer > MCP to see connected servers. `arc` should be listed.
